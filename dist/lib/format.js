...
export function formatBrowse(generations) {
...
export function formatError(res) {
    ...
    if (res.data && typeof res.data === "object") {
        ...
        if (d["code"] && !(err && typeof err === "object"))
